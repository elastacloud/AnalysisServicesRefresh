...
{
    public class SqlServerOAuthCertificateTokenProvider : BaseCertificateTokenProvider
    {
        public SqlServerOAuthCertificateTokenProvider(ModelConfiguration model) : base(model)
        {
        }
